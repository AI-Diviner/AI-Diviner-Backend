...
import fun.diviner.ai.diviner.MeiHua;
import fun.diviner.ai.diviner.meihua.MeiHuaObj;
import fun.diviner.ai.diviner.meihua.MeiHuaSetting;
import fun.diviner.ai.diviner.type.MeiHuaArrangeResponse;
import fun.diviner.ai.diviner.type.MeiHuaGuaItem;
