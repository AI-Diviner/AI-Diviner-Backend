package fun.diviner.aidiviner.diviner;
...
import fun.diviner.aidiviner.diviner.ai.AIModel;
import fun.diviner.aidiviner.diviner.type.TarotResponse;
import fun.diviner.aidiviner.entity.database.ToolTarotCard;
import fun.diviner.aidiviner.entity.database.ToolTarotSpread;
import fun.diviner.aidiviner.mapper.ToolTarotCardMapper;
import fun.diviner.aidiviner.mapper.ToolTarotSpreadMapper;
...
import fun.diviner.aidiviner.diviner.ai.AIRequestUtil;
