package fun.diviner.aidiviner.diviner.meihua;
...
//************************************************************************************************************************************
     ...
     */
    public MeiHuaObj(Date date, int dateType) {
     ...
     */
//    public MeiHuaObj(int year, int month, int day, int hour, int minute, int second) {
...
//    }
     ...
     * @param dateType 日期类型（0:公历。1:农历）
     */
//    public MeiHuaObj(int year, int month, int day, int hour, int dateType, int minute, int second) {
...
//    }
     ...
     */
    public MeiHuaObj(MeiHuaSetting setting) {
        core(setting);
    }
