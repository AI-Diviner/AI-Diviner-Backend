package fun.diviner.aidiviner.diviner.bazi;
...
import fun.diviner.aidiviner.diviner.bazi.shensha.BaZiShenShaUtil;
import fun.diviner.aidiviner.diviner.util.CommonUtil;
import fun.diviner.aidiviner.diviner.util.DateUtil;
...
//****************************************************************************************************************************************************
     ...
     */
    public BaZiTool(Date date, int dateType) {
     ...
     * @param second 秒（0~60）
     */
    public BaZiTool(int year, int month, int day, int hour, int minute, int second) {
     ...
     * @param setting 八字-设置
     */
    public BaZiTool(BaZiSetting setting) {
        core(setting);
    }
...
//        System.out.println("身体强弱：" + bodyIntensity);
    ...
    private void guZhong() {
        ...
        int monthGuZhong = monthMap.get(getLunar().getMonthInChinese()); // 出生月骨重
