package fun.diviner.aidiviner.diviner.liuyao;
...
//************************************************************************************************************************************
     ...
     */
    public LiuYaoObj(Date date, int dateType) {
     ...
     */
    public LiuYaoObj(int year, int month, int day, int hour, int minute, int second) {
     ...
     * @param dateType 日期类型（0:公历。1:农历）
     */
    public LiuYaoObj(int year, int month, int day, int hour, int dateType, int minute, int second) {
     ...
     * @param setting 设置
     */
    public LiuYaoObj(LiuYaoSetting setting) {
        core(setting); // 获取并设置数据
    }
